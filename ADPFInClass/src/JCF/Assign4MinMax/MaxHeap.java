...
public class MaxHeap {
    ...
    /**
     * Ensure that A maintains max heap property after insertion
     */
    ...
    public int delete()
    {
        ...
        else
        {
        	...
        	// Ensure A satisfies Max Heap property
            heapifyDown();
    ...
    public void heapifyDown()
    {
        ...
        while (true)
        {
            ...
            {
            	// Find the child that is maximum
                int maxIndex = (A.get(leftIndex)> A.get(rightIndex)?
                		leftIndex:rightIndex);
                
                // Compare the parent with its minimum of left and
                // right child
                if(A.get(tempIndex) < A.get(maxIndex))
                {
